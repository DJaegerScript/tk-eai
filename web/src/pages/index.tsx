    ...
    <div className='min-h-screen bg-gradient-to-r from-purple-700 to-blue-400 flex flex-col justify-center items-center'>
      ...
      <div className='container mx-auto grid grid-cols-1 md:grid-cols-2 items-center justify-center flex-grow'>
        ...
        <div className='flex flex-col md:mr-10 md:ml-20 md:mt-7'>
          <h1 className='left-aligned font-bold text-4xl leading-6 text-white mx-4'>
            EAI Job Scrapper
          </h1>
          <p className='left-aligned text-lg leading-6 text-white mx-4 md:mt-7'>
            EAI Job Scrapper adalah platform yang menyediakan informasi lowongan
            pekerjaan seputar programmer, data science, network, dan siber di
            Indonesia secara terpusat. Kami mengumpulkan data dari berbagai
            situs pencarian lowongan kerja populer seperti karir.com,
            jobstreet.co.id, kalibrr.com, dan linkedin.com/jobs.
          </p>
        </div>
            ...
            {categories.slice(0, 2).map((category) => (
              ...
              >
                <img
                  src={category.image}
                  alt={category.name}
                  className='h-50 w-50 md:h-50 md:w-50 hover:opacity-75'
                />
              </button>
            ))}
          </div>
